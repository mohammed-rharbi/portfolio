      ...
      <section className="relative overflow-hidden">
        <div className="container mx-auto px-6 lg:px-20 flex flex-col md:flex-row items-center gap-12 py-16 relative z-10">
          ...
          <div className="md:w-1/2 relative group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-[#FFD700] to-[#FFA500] rounded-xl 
              opacity-40 group-hover:opacity-70 transition duration-500 
              blur-2xl group-hover:blur-3xl"></div>
            ...
            <img
              ...
              className="relative w-full max-w-sm mx-auto rounded-xl 
                ...
                transition duration-500 transform hover:scale-102"
            />
          </div>
        </div>
